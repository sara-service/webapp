...
import bwfdm.sara.git.github.GitHubRESTv3WithoutShib;
...
public class GitRepoFactory {
	...
	static {
		...
		ADAPTERS.put("GitHubRESTv3WithoutShib", GitHubRESTv3WithoutShib.class);
		ADAPTERS.put("GitHubRESTv3", GitHubRESTv3WithShib.class);
	}

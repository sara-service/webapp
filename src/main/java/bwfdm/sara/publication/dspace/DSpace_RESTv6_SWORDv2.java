...
/** high-level abstraction of the DSpace RESTv6 + SWORDv2 API. */
public class DSpace_RESTv6_SWORDv2 implements PublicationRepository {
	 ...
	 */
	@JsonCreator
	public DSpace_RESTv6_SWORDv2(@JsonProperty("rest_user") final String ru, @JsonProperty("rest_pwd") final String rp,
